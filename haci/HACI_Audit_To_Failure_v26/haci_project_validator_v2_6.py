...
v2.6 fixes:
1. Keeps commit gating from v2.5.
2. Adds accepted-return pairing for suffix !.
3. A single ! return may close one single same-object open ask without token overlap.
4. Multiple open asks still fail closed.
5. Suffix > still requires unique payload relation; no blind observe pairing.
"""
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(description="HACI Project Validator v2.6")
