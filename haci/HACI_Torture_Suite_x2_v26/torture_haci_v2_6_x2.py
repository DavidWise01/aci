...
def c_multiple_remaining_returns_accept(name, r):
    # v2.6 should not use accepted fallback when there are multiple remaining returns.
...
WORDS = [
    ...
    "needle", "thread", "model", "approve", "deployment", "accepted"
]
...
def main():
    ...
    try:
        ...
        report = {
            "suite": "HACI Torture Suite x2 for v2.6",
            "pass": PASS,
            "fail": FAIL,
