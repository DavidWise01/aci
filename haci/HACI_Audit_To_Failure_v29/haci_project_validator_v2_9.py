...
v2.9 fixes:
1. Keeps return-question pairing from v2.8.
2. Adds pending-declaration edge gate.
3. Pending declarations do not create dependency edges.
4. Pending declarations cannot create dependency cycles.
5. Real asks/observes and committed declarations still create dependency edges.
"""
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(description="HACI Project Validator v2.9")
