...
v3.1 fixes:
1. Keeps same-file chronology gate from v3.0.
2. Allows multiple suffix ? return-questions to attach to one open conversation.
3. Each return-question must still have a positive unique conversation match.
4. Return-questions still do not complete the conversation.
5. Final suffix > or ! still completes the conversation.
"""
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(description="HACI Project Validator v3.1")
