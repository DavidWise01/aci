...
v3.3 fixes:
1. Keeps multi evidence return attachment from v3.2.
2. Allows multiple positive suffix ! commit/ack returns to attach to one conversation.
3. Each positive ! return still needs a positive unique conversation match.
4. The old no-token accepted-return fallback remains conservative.
5. Ambiguous ! returns still fail closed.
"""
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(description="HACI Project Validator v3.3")
