...
v2.7 fixes:
1. Keeps accepted-return pairing from v2.6.
2. Adds pending-parent scope gate.
3. Committed child symbols cannot sit beneath pending/uncommitted parent symbols.
4. Violations are structural errors even in non-strict mode.
5. Blocked child commits are demoted from committed state.
"""
...
def main(argv=None) -> int:
    parser = argparse.ArgumentParser(description="HACI Project Validator v2.7")
